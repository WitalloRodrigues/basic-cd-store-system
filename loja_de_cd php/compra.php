...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      ...
      <div id="gallery">
        <figure>
          <header class="heading">COMPRANDO</header>
    ...
    <table border="1">
    	...
    	<tbody>
         ...
         foreach ($_SESSION['dados'] as $key ) { ?>
    		 <tr>
               <?php if ($key['promocao']==0){?>
                <td><?php echo $key['name']; ?></td>
                <td>R$<?php echo number_format($key['price'], 2, ',', '.')?></td>
                <td><?php echo $key['quantity']; ?></td>
                <td>R$<?php echo number_format($key['subtotal'], 2, ',', '.')?></td>
                <?php $tot = $key['subtotal']; ?>
                <?php $total +=$tot ; ?>
               <?php }else{?>
                <td><?php echo $key['name']; ?></td>
                <td>R$<?php echo number_format($key['preco'], 2, ',', '.')?></td>
                <td><?php echo $key['quantity']; ?></td>
                <td>R$<?php echo number_format($key['subcon'], 2, ',', '.')?></td>
                <?php $tot = $key['subcon']; ?>
                 <?php $total +=$tot ; ?>
               <?php } ?>
        </tr>
    	...
    	<?php } ?>
    	<tr><th colspan="2" >total</th><td colspan="2" align="center">R$<?php echo number_format($total, 2, ',', '.'); ?></td></tr>
    </table>
    <br>
</center>
...
$sql ="INSERT INTO `pedido` (`id_pedido`, `id_cliente`,`total`,`data`) VALUES (NULL,'".$id_cliente."','".$total."','".$data."')";
//echo $sql; INSERT INTO `pedido_itens` (`id_pedido`, `id_cliente`, `id_cd`, `quantidade`, `data`) VALUES ('4', '2', '2', '2', '2021');

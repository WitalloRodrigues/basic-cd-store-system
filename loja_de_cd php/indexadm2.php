                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                            <li><a href="indexadm.php" class="menu-top-active">DASHBOARD</a></li>
                           
                            <li><a href="form.php">FORMS</a></li>
                            <li>
                                <a href="#" class="dropdown-toggle" id="ddlmenuItem" data-toggle="dropdown">CADASTROS <i class="fa fa-angle-down"></i></a>
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="ui.php">cadastrar cd</a></li>
                                     <li role="presentation"><a role="menuitem" tabindex="-1" href="#">cadastrar genero</a></li>
                                </ul>
                            </li>
...
<img class="img-thumbnail" src="assets/img/user.gif" />
                            <img class="img-thumbnail" src="assets/img/01.png" />
                            <img class="img-thumbnail" src="assets/img/user.gif" />

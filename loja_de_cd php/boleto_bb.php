...
if (isset($_SESSION['nor'])==0) {
  ...
  $id_cliente = $_SESSION['id'];
      ...
      $total = 0;
           ...
           $sql = "select  c.preco, pi.quantidade from cd as c join pedido_itens as pi on c.id_cd = pi.id_cd where
...
// codigo criado
$valor_cobrado =  $num; // Valor - REGRA: Sem pontos na milhar e tanto faz com "." ou "," ou com 1 ou 2 ou sem casa decimal
$valor_cobrado = str_replace(",", ".",$valor_cobrado);
$valor_boleto=number_format($valor_cobrado+$taxa_boleto, 2, ',', '');

$dadosboleto["nosso_numero"] = "9876";
...
$dadosboleto["convenio"] = "55 85";  // Num do conv�nio - REGRA: 6 ou 7 ou 8 d�gitos
...
// SEUS DADOS
$dadosboleto["identificacao"] = "WITALLLO-boleto";
$dadosboleto["cpf_cnpj"] = "9999";
$dadosboleto["endereco"] = "rua sena de almeda";
$dadosboleto["cidade_uf"] = "Caucaia / Ceara";
$dadosboleto["cedente"] = "Loja de cd";

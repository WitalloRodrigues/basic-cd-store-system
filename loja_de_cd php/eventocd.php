...
$sql = "update cd set id_genero='".$genero."',capa= '".$nome_final."',titulo='".$titulo."',preco='".$preco."',anoLancamento='".$data."',disponibilidade='".$disponibilidade."',descricao='".$descricao."',desconto='".$desconto."'  where id_cd=".$_GET['editarcd'];
mysqli_query($con ,$sql);    

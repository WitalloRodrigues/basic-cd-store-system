...
#instr_header {
	background: url('fotos/300.png') no-repeat top left;
	padding-left: 160px;
	height: 65px;
}
...
do Sacado</b></div></TD></tr></tbody></table>
    ...
    <table cellspacing=0 cellpadding=0 width=666 border=0><TBODY><TR><TD width=666 align=right ><font style="font-size: 10px;">Autentica&ccedil;&atilde;o mec&acirc;nica - Ficha de Compensacao</font></TD></tr></tbody></table>
		<div class="barcode">
